            ...
            <div class="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-lg max-w-6xl w-full max-h-[95vh] overflow-y-auto">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="bg-white rounded-lg p-5 shadow-sm border border-blue-200">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                <label class="block text-base font-bold text-gray-800 mb-2">نوع سفارش</label>
                                <select id="edit-order-type" class="w-full bg-white border border-gray-300 rounded-lg px-4 py-2.5 text-lg">
                                    <option value="">انتخاب کنید</option>
                                    <option value="نوشتن رساله" ${student.orderType === 'نوشتن رساله' ? 'selected' : ''}>نوشتن رساله</option>
                                    <option value="نوشتن مقاله" ${student.orderType === 'نوشتن مقاله' ? 'selected' : ''}>نوشتن مقاله</option>
                                    <option value="ترجمه رساله" ${student.orderType === 'ترجمه رساله' ? 'selected' : ''}>ترجمه رساله</option>
                                    <option value="تلخیص" ${student.orderType === 'تلخیص' ? 'selected' : ''}>تلخیص</option>
                                </select>
                            </div>
                            <div>
                                <label class="block text-base font-bold text-gray-800 mb-2">وضعیت لجنه</label>
                                <select id="edit-committee-status" class="w-full bg-white border border-gray-300 rounded-lg px-4 py-2.5 text-lg">
                                    <option value="">انتخاب کنید</option>
                                    <option value="در انتظار" ${student.committeeStatus === 'در انتظار' ? 'selected' : ''}>در انتظار</option>
                                    <option value="تایید شده" ${student.committeeStatus === 'تایید شده' ? 'selected' : ''}>تایید شده</option>
                                    <option value="نیاز به اصلاح" ${student.committeeStatus === 'نیاز به اصلاح' ? 'selected' : ''}>نیاز به اصلاح</option>
                                </select>
                            </div>
                            <div>
                                <label class="block text-base font-bold text-gray-800 mb-2">وضعیت ایران‌داک</label>
                                <select id="edit-irandoc-status" class="w-full bg-white border border-gray-300 rounded-lg px-4 py-2.5 text-lg">
                                    <option value="">انتخاب کنید</option>
                                    <option value="ثبت نشده" ${student.irandocStatus === 'ثبت نشده' ? 'selected' : ''}>ثبت نشده</option>
                                    <option value="در حال بررسی" ${student.irandocStatus === 'در حال بررسی' ? 'selected' : ''}>در حال بررسی</option>
                                    <option value="تایید شده" ${student.irandocStatus === 'تایید شده' ? 'selected' : ''}>تایید شده</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg p-5 shadow-sm border border-blue-200">
                        <h4 class="text-lg font-bold text-gray-800 mb-4 border-b pb-2">
                            <i class="fas fa-tools text-indigo-600 ml-2"></i>
                            خدمات اضافی
                        </h4>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-base font-bold text-gray-800 mb-2">وضعیت امورداری</label>
                                <select id="edit-secretariat-status" class="w-full bg-white border border-gray-300 rounded-lg px-4 py-2.5 text-lg">
                                    <option value="">انتخاب کنید</option>
                                    <option value="انجام نشده" ${student.secretariatStatus === 'انجام نشده' ? 'selected' : ''}>انجام نشده</option>
                                    <option value="در حال انجام" ${student.secretariatStatus === 'در حال انجام' ? 'selected' : ''}>در حال انجام</option>
                                    <option value="تکمیل شده" ${student.secretariatStatus === 'تکمیل شده' ? 'selected' : ''}>تکمیل شده</option>
                                </select>
                            </div>
                            <div>
                                <label class="block text-base font-bold text-gray-800 mb-2">وضعیت تنضید</label>
                                <select id="edit-typesetting-status" class="w-full bg-white border border-gray-300 rounded-lg px-4 py-2.5 text-lg">
                                    <option value="">انتخاب کنید</option>
                                    <option value="انجام نشده" ${student.typesettingStatus === 'انجام نشده' ? 'selected' : ''}>انجام نشده</option>
                                    <option value="در حال انجام" ${student.typesettingStatus === 'در حال انجام' ? 'selected' : ''}>در حال انجام</option>
                                    <option value="تکمیل شده" ${student.typesettingStatus === 'تکمیل شده' ? 'selected' : ''}>تکمیل شده</option>
                                </select>
                            </div>
                            <div>
                                <label class="block text-base font-bold text-gray-800 mb-2">وضعیت تلخیص</label>
                                <select id="edit-summary-status" class="w-full bg-white border border-gray-300 rounded-lg px-4 py-2.5 text-lg">
                                    <option value="">انتخاب کنید</option>
                                    <option value="انجام نشده" ${student.summaryStatus === 'انجام نشده' ? 'selected' : ''}>انجام نشده</option>
                                    <option value="در حال انجام" ${student.summaryStatus === 'در حال انجام' ? 'selected' : ''}>در حال انجام</option>
                                    <option value="تکمیل شده" ${student.summaryStatus === 'تکمیل شده' ? 'selected' : ''}>تکمیل شده</option>
                                </select>
                            </div>
                            <div>
                                <label class="block text-base font-bold text-gray-800 mb-2">وضعیت همانند</label>
                                <select id="edit-similarity-status" class="w-full bg-white border border-gray-300 rounded-lg px-4 py-2.5 text-lg">
                                    <option value="">انتخاب کنید</option>
                                    <option value="انجام نشده" ${student.similarityStatus === 'انجام نشده' ? 'selected' : ''}>انجام نشده</option>
                                    <option value="در حال انجام" ${student.similarityStatus === 'در حال انجام' ? 'selected' : ''}>در حال انجام</option>
                                    <option value="تکمیل شده" ${student.similarityStatus === 'تکمیل شده' ? 'selected' : ''}>تکمیل شده</option>
                                </select>
                            </div>
                            <div>
                                <label class="block text-base font-bold text-gray-800 mb-2">وضعیت مقاله ۱</label>
                                <select id="edit-article1-status" class="w-full bg-white border border-gray-300 rounded-lg px-4 py-2.5 text-lg">
                                    <option value="">انتخاب کنید</option>
                                    <option value="شروع نشده" ${student.article1Status === 'شروع نشده' ? 'selected' : ''}>شروع نشده</option>
                                    <option value="در حال نوشتن" ${student.article1Status === 'در حال نوشتن' ? 'selected' : ''}>در حال نوشتن</option>
                                    <option value="ارسال شده" ${student.article1Status === 'ارسال شده' ? 'selected' : ''}>ارسال شده</option>
                                    <option value="پذیرش شده" ${student.article1Status === 'پذیرش شده' ? 'selected' : ''}>پذیرش شده</option>
                                </select>
                            </div>
                            <div>
                                <label class="block text-base font-bold text-gray-800 mb-2">وضعیت مقاله ۲</label>
                                <select id="edit-article2-status" class="w-full bg-white border border-gray-300 rounded-lg px-4 py-2.5 text-lg">
                                    <option value="">انتخاب کنید</option>
                                    <option value="شروع نشده" ${student.article2Status === 'شروع نشده' ? 'selected' : ''}>شروع نشده</option>
                                    <option value="در حال نوشتن" ${student.article2Status === 'در حال نوشتن' ? 'selected' : ''}>در حال نوشتن</option>
                                    <option value="ارسال شده" ${student.article2Status === 'ارسال شده' ? 'selected' : ''}>ارسال شده</option>
                                    <option value="پذیرش شده" ${student.article2Status === 'پذیرش شده' ? 'selected' : ''}>پذیرش شده</option>
                                </select>
                            </div>
                        </div>
                    </div>
