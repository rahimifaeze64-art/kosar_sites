...
const MessagesModule = {
                ...
                <div class="flex items-start space-x-3 space-x-reverse">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            ${unreadCount > 0 ? `
                                <span class="bg-lime-500 text-gray-900 text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center">
                                    ${unreadCount}
                                </span>
                            ` : ''}
                        </div>
    ...
    getMessageHTML(message) {
        ...
        const bgColor = isMe ? 'bg-lime-600' : 'bg-slate-700';
        ...
        return `
            <div class="flex ${alignment} mb-4">
                <div class="max-w-md ${bgColor} rounded-lg p-3 shadow-lg">
                    ${contentHTML}
                    <div class="flex items-center justify-between mt-2 text-xs ${isMe ? 'text-lime-200' : 'text-gray-400'}">
            ...
            <div class="bg-slate-700 rounded-lg p-3 flex items-center justify-between">
                <div class="flex items-center space-x-3 space-x-reverse">
                    <div class="w-10 h-10 rounded-lg bg-slate-600 flex items-center justify-center">
                        <i class="fas ${fileIcon} text-lime-400"></i>
                    </div>
                    <div>
    ...
    getFileIcon(fileName) {
        ...
        const iconMap = {
            ...
            'jpeg': 'fa-file-image text-lime-400',
            'png': 'fa-file-image text-lime-400',
            'gif': 'fa-file-image text-lime-400',
            ...
            'mp4': 'fa-file-video text-lime-400',
        };
