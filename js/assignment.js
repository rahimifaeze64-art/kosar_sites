                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ${doctors.map(doctor => `
                                    <div class="doctor-card border-2 rounded-lg p-4 cursor-pointer transition-all hover:border-lime-400 hover:bg-lime-50"
                                         :class="selectedDoctor === '${doctor.id}' ? 'border-lime-600 bg-lime-50' : 'border-gray-200'"
                                         @click="selectedDoctor = '${doctor.id}'"
                                         onclick="selectDoctor('${doctor.id}')">
                                        <div class="flex items-center">
                                            <div class="w-12 h-12 bg-lime-100 rounded-full flex items-center justify-center ml-3">
                                                <i class="fas fa-user-md text-lime-600 text-xl"></i>
                                            </div>
                                            <div class="flex-1">
                                            ...
                                            <div x-show="selectedDoctor === '${doctor.id}'" class="text-lime-600 doctor-check" style="display: none;">
        ...
        window.selectDoctor = (doctorId) => {
            try {
                ...
                document.querySelectorAll('.doctor-card').forEach(card => {
                    card.classList.remove('border-lime-600', 'bg-lime-50');
                ...
                if (selectedCard) {
                    ...
                    selectedCard.classList.add('border-lime-600', 'bg-lime-50');
